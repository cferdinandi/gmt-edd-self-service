 ...
 */
	...
	// Set session data
	function gmt_edd_self_service_set_session( $name, $value, $sanitize = null ) {
	...
	// Get session data
	function gmt_edd_self_service_get_session( $name, $unset = false ) {
	...
	// Unset session data
	function gmt_edd_self_service_unset_session( $name ) {
		$wp_session = WP_Session::get_instance();
		unset( $wp_session[$name] );
	}
	...
	function gmt_edd_self_service_get_url() {
	...
	function gmt_edd_self_service_get_site_domain() {
	...
	function gmt_edd_self_service_prepare_url( $url ) {
	...
	function gmt_edd_self_service_clean_url( $variable, $url ) {
