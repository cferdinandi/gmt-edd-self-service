...
function gmt_edd_self_service_set_submit_string() {

	if ( empty( get_site_option( 'gmt_edd_self_service_submit_hash' ) ) ) {
		update_site_option( 'gmt_edd_self_service_submit_hash', wp_generate_password( 24, false ) );
	}
